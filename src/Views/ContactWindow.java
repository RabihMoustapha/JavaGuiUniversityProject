...
public class ContactWindow extends JFrame {
    ...
    public JButton getBtnSortByFirstName() { return btnSortByFirstName; }
    public JButton getBtnSortByLastName() { return btnSortByLastName; }
    public JButton getBtnSortByCity() { return btnSortByCity; }
    public JButton getBtnAddContact() { return btnAddContact; }
    public JButton getBtnUpdateContact() { return btnUpdateContact; }
    public JButton getBtnDeleteContact() { return btnDeleteContact; }
    public JButton getBtnViewContact() { return btnViewContact; }
    public JTextField getSearchField() { return searchField; }
    public JList<String> getContactList() { return contactList; }
}