...
public class GroupController {
				...
				saveButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							Groupes.add(c);
							try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(GroupesData))) {
	...
	public ActionListener getDeleteListener() {
		return new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int index = GroupeList.getSelectedIndex();
				if (index >= 0) {
					int confirm = JOptionPane.showConfirmDialog(null, "Supprimer ce Groupe ?", "Confirmation",
	...
	private void showSelectionWarning() {
		JOptionPane.showMessageDialog(null, "Veuillez sélectionner un Groupe", "Aucune sélection",
				...
				saveButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						try {
							...
							contacts.add(c);
							try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(ContactsData))) {
