...
//	}
	...
	private void openContactsWindow() {
	    // Création d'une instance de ContactWindow
	    ContactWindow contactWindow = new ContactWindow();

	    // Configuration de la fenêtre si nécessaire
	    contactWindow.setTitle("Gestion des Contacts");
	    contactWindow.setSize(800, 600);
	    contactWindow.setLocationRelativeTo(null); // Centrer la fenêtre
